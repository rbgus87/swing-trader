...
def run():
    ...
    variants = [
        # (#, 자본, 종목수, TP1, TP2, cap_lbl, tp_lbl)
        (1, 5_000_000,  4, 0.10, 0.10, '5M/4',  '10/10/80'),
        (2, 5_000_000,  4, 0.05, 0.05, '5M/4',  '5/5/90'),
        (3, 5_000_000,  4, 0.05, 0.10, '5M/4',  '5/10/85'),
        (4, 10_000_000, 6, 0.10, 0.10, '10M/6', '10/10/80'),
        (5, 10_000_000, 6, 0.10, 0.20, '10M/6', '10/20/70'),
        (6, 10_000_000, 6, 0.10, 0.30, '10M/6', '10/30/60'),
    ]
    ...
    print("\n" + "=" * 100)
    print("📋 실험 17c: TP1 10% 최종")
    print("=" * 100)
    print(f"Period: {rows[0][3].period} / 총 소요: {total_time:.1f}s")
    print()
    print(f"{'#':<3} {'자본/종목':<10} {'TP비율':<10} {'건수':>5} {'WR':>6} {'PF':>5} {'CAGR':>7} {'MDD':>7} {'순손익':>14} {'CAGR/MDD':>9}")
    print("-" * 95)
